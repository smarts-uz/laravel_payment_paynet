...
use Payment\Paynet\Helpers\DataFormat;
use Payment\Paynet\Helpers\PaynetException;
use Payment\Paynet\Http\Classes\Merchant;
use Payment\Paynet\Http\Classes\Request as PaynetRequest;
use Payment\Paynet\Http\Classes\Response as PaynetResponse;
...
class PaynetService
{
    ...
    {
        $this->config   = [
            'login'    =>  config('paynet.username'),
            'password' =>  config('paynet.password')
        ];
